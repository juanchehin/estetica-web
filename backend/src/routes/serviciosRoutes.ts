...
class ServiciosRoutes {
    ...
    config(): void {
        ...
        this.router.get('/listar/busqueda/autocomplete/:pServicioBuscado/:pIdSucursalOrigen/:IdPersona',  [mdAutenticacion.verificaToken],serviciosController.buscarServicioAutoComplete); 
